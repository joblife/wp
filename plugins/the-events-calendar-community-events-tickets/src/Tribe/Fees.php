...
class Tribe__Events__Community__Tickets__Fees {
	 ...
	 *
	 * @since 4.6.2
	 * @since 4.7.1 - Add optional event id to return total fee for an event and not the order.
	 *
	 ...
	 *
	 * @since 4.6.2
	 * @since 4.7.1 - Added an optional event id to return total fee for an event and not the order.
	 *
