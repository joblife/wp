	...
	public function fee_total( $event_id ) {
		...
		if ( $event_fees ) {
			...
			<div class="tribe-event-meta tribe-event-meta-total-ticket-sales">
				<strong><?php esc_html_e( 'Total Completed Sales:', 'tribe-events-community-tickets' ); ?></strong>
			...
			<div class="tribe-event-meta tribe-event-meta-total-site-fees">
				<strong><?php esc_html_e( 'Total Site Fees:', 'tribe-events-community-tickets' ); ?></strong>
