...
<?php
do_action( 'tribe_commuity_tickets_before_the_payment_options' );
do_action_deprecated(
	'tribe_ct_before_the_payment_options',
	[],
	'4.6.3',
	'tribe_commuity_tickets_before_the_payment_options',
	'The action "tribe_ct_before_the_payment_options" has been renamed to "tribe_commuity_tickets_before_the_payment_options" to match plugin namespacing.'
);
