                ...
                <tr valign="top">   
                    ...
                    <td>
                        ...
                        if ($status !== false && ($status == 'valid' || $status == 'expired' || $previousStatus=="valid"||$previousStatus=="expired")) {
                            ...
                            ?>
                            <input type="submit" class="button-primary" name="<?php echo 'edd_' . $this->pluginSlug .'_license_deactivate';
                            ?>" value="<?php _e('Deactivate License', $this->pluginTextDomain);
                            ?>"/>
                            <?php
                            if ($status == 'expired') {
                                ?>
                                <input type="button" class="button-primary" name="<?php echo 'edd_' . $this->pluginSlug .'_license_renew';
                                ?>" value="<?php _e('Renew License', $this->pluginTextDomain);
                            ...
                            ?>
                            <input type="submit" class="button-primary" name="<?php echo 'edd_' . $this->pluginSlug .'_license_activate';
                            ?>" value="<?php _e('Activate License', $this->pluginTextDomain);
                            ?>"/>
                        <?php
