	...
	<div class="content-review-details">
		<div class="comment-review-inner">
			<div class="review-head">
				...
				<?php echo rrf_get_star_html_struct( $course_id, $rating, $rating_args );// WPCS: XSS ok. ?>
			...
			<div class="review-body">
				...
				<p class="review-desc"><?php echo convert_smilies( $review->post_content ); // WPCS : XSS ok. ?></p>
