	  ...
	  for (var i in icons) {
		  $list.append('<li data-icon="'+icons[i]+'"><a href="#" title="'+icons[i]+'"><span class="'+options[0]+' '+options[1]+'-'+icons[i]+'"></span></a></li>');
				...
				$('a', $list).click(function(e) {
					...
					$button.removeClass().addClass("eat-button icon-picker "+options[0]+" "+options[1]+"-"+title);
					removePopup();
				});
	};
			...
			function createPopup($button) {
				...
				$control.html('<p>Select Font: <select><option value="dashicons">Dashicons</option></select></p>'+
